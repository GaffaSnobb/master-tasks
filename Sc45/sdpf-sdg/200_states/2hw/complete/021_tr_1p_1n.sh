...
echo "start running log_Sc45_GCLSTsdpfsdgix5pn_tr_j1p_j1n.txt ..."
cat > Sc45_GCLSTsdpfsdgix5pn_1p_1n.input <<EOF
&input
...
&end
EOF
mpiexec ./transit.exe Sc45_GCLSTsdpfsdgix5pn_1p_1n.input > log_Sc45_GCLSTsdpfsdgix5pn_tr_j1p_j1n.txt  

rm -f Sc45_GCLSTsdpfsdgix5pn_1p_1n.input
