...
echo "start running log_Sc45_GCLSTsdpfsdgix5pn_tr_j3p_j3n.txt ..."
cat > Sc45_GCLSTsdpfsdgix5pn_3p_3n.input <<EOF
&input
...
&end
EOF
mpiexec ./transit.exe Sc45_GCLSTsdpfsdgix5pn_3p_3n.input > log_Sc45_GCLSTsdpfsdgix5pn_tr_j3p_j3n.txt  

rm -f Sc45_GCLSTsdpfsdgix5pn_3p_3n.input
