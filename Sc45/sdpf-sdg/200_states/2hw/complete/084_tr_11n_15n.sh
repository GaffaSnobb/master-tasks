...
echo "start running log_Sc45_GCLSTsdpfsdgix5pn_tr_j11n_j15n.txt ..."
cat > Sc45_GCLSTsdpfsdgix5pn_11n_15n.input <<EOF
&input
...
&end
EOF
mpiexec ./transit.exe Sc45_GCLSTsdpfsdgix5pn_11n_15n.input > log_Sc45_GCLSTsdpfsdgix5pn_tr_j11n_j15n.txt  

rm -f Sc45_GCLSTsdpfsdgix5pn_11n_15n.input
