...
echo "start running log_Zn64_gs8_tr_j12p_j14p.txt ..."
cat > Zn64_gs8_12p_14p.input <<EOF
&input
  fn_int   = "gs8.snt"
...
&end
EOF
mpiexec ./transit.exe Zn64_gs8_12p_14p.input > log_Zn64_gs8_tr_j12p_j14p.txt  

rm -f Zn64_gs8_12p_14p.input
